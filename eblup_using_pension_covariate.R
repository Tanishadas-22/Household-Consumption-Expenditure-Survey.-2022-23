...
write.csv(distance_matrix,"distance_matrix_usingformula_new.csv")
...
# Moran.I(merged$Urban_MPCE[-50], myproxmat[-50,-50], scaled=TRUE)

merged$URBAN
#Srawasti predicted UMPCE = 4196+0.13*125 = 4212.25
